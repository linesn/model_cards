...
```bash
MODEL_PATH=/path/to/WeMM-Embedding-4B
...
WeMM-Embedding-4B, including the code, model parameters, and weights made publicly
available by Tencent, is licensed under the [Apache License 2.0](https://huggingface.co/tencent/WeMM-Embedding-4B/blob/main/LICENSE).
