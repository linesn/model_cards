...
> [!NOTE]
> This is the FP8 variant with an FP8-quantized KV cache. The [BF16](https://huggingface.co/poolside/Laguna-XS.2), [NVFP4](https://huggingface.co/poolside/Laguna-XS.2-NVFP4) and [INT4](https://huggingface.co/poolside/Laguna-XS.2-INT4) variants are also available on Hugging Face.
...
Laguna XS.2 is supported in SGLang via [sgl-project/sglang#24204](https://github.com/sgl-project/sglang/pull/24204). Quantization is detected automatically from `quantization_config`, so no extra flags are required. See the [SGLang cookbook entry](https://github.com/sgl-project/sglang/pull/24730) and the main [Laguna XS.2 model card](https://huggingface.co/poolside/Laguna-XS.2) for a serving recipe.

#### Transformers

The full Transformers recipe is on the main [Laguna XS.2 model card](https://huggingface.co/poolside/Laguna-XS.2). Substitute `poolside/Laguna-XS.2-FP8` for the model ID; quantization is detected automatically from `quantization_config`.
...
# OVERLAY built from poolside/Laguna-XS.2-FP8 via laguna_minimal_overlay.sh
